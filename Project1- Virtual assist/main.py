...
class Widget():
    ...
    def send_func(self):
        ...
        elif 'navneet'  in user_input:
            out = 'He Is A Good Friend Of Yours. He is well Known amongs girls '                                                                                               #|
            self.printing_func(out)                                                                                    #|
            self.speak(out)


        elif 'dharm'  in user_input:
                out = 'He Is A Good Friend Of Yours. And he is short in height and also called bampudka '                                                                                               #|
                self.printing_func(out)                                                                                    #|
                self.speak(out)
